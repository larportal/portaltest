<%@ Page Title="" Language="C#" MasterPageFile="~/Profile/Profile.Master" AutoEventWireup="true" CodeBehind="Security.aspx.cs" Inherits="LarpPortal.Profile.Security" %>
<asp:Content ID="Security" ContentPlaceHolderID="ProfileMain" runat="server">
	        ...
	        <div role="form" class="form-horizontal form-condensed">
		        ...
		        <div class="userSecurity">
			        ...
			        <div class="formGroup row">                        
				        ...
				        <div class="pass-word col-sm-3">
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" BackColor="White"></asp:TextBox>
				        </div>
			        </div>
			        <div class="formGroup row">
				        <asp:Label ID="lblPassword2" runat="server" Cssclass="control-label col-sm-1">Password</asp:Label>
				        <div class="pass-word col-sm-3">
                            <asp:TextBox ID="txtPassword2" runat="server" TextMode="Password" BackColor="White"></asp:TextBox>
				        </div>
			        </div>
		        ...
		        <div class="row">
			        <div class="col-sm-2 col-sm-offset-10 text-right">
				        <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" CssClass="StandardButton" Width="100px"/>
			        </div>
		        </div>
	        </div>
        </section>
