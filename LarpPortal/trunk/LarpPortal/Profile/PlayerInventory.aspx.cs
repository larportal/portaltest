...
namespace LarpPortal.Profile
{
    public partial class PlayerInventory : System.Web.UI.Page
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            Classes.cPlayer PLPlayerInfo = new Classes.cPlayer(_UserID, _UserName);
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dtTypes = cUtilities.LoadDataTable("uspGetInventoryTypes", sParams, "LARPortal", _UserName, lsRoutineName);
        ...
        protected void btnDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Classes.cPlayerInventory cInvItem = new cPlayerInventory(iDeleteInventoryID, _UserName, _UserID);
                cInvItem.RecordStatus = RecordStatuses.Delete;
                cInvItem.Delete(_UserName, _UserID);
            }
        }
            ...
            try
            {
                if (int.TryParse(hidInventoryID.Value, out iInventoryID))
                {
                    ...
                    if (fuItemPicture.HasFile)
                    {
                        ...
                        NewPicture.CreateNewPictureRecord(cPicture.PictureTypes.Item, sExtension, _UserName);
                        ...
                        catch (Exception ex)
                        {
                            ...
                            lobjError.ProcessError(ex, lsRoutineName + ".PicutreSaveAs", _UserName);
                        }
                        NewPicture.Save(_UserName);
                    ...
                    Classes.cPlayerInventory cInvItem = new cPlayerInventory(iInventoryID, _UserName, _UserID);
                    ...
                    cInvItem.Save(_UserName, _UserID);
                }
            }
            catch (Exception ex)
            {
                lblMessage.Text += "There was a general error saving the file. The message was<br>" +
                    ...
                    ex.StackTrace + "<br>";
                ErrorAtServer lobjError = new ErrorAtServer();
                lobjError.ProcessError(ex, lsRoutineName, _UserName);
            }
