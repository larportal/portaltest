...
{
    public partial class GameSystemOwnerCampaignList : System.Web.UI.Page
    {
        ...
        {
            //int iTemp = 0;
            //uspGetGameSystemCampaignsByOwner
            //    -- Add the parameters for the stored procedure here
            //    @GameSystemOwnerID
            int UserID = 0;
            string UserName;
            string stStoredProc = "uspGetGameSystemCampaignsByOwner";
            string stCallingMethod = "GameSystemOwnerCampaignList.FillGrid";
            ...
            sParams.Add("@GameSystemOwnerID", UserID);
            dtGameSystem = Classes.cUtilities.LoadDataTable(stStoredProc, sParams, "LARPortal", UserName, stCallingMethod);
            gvCalendar.DataSource = dtGameSystem;
            gvCalendar.DataBind();
        }
