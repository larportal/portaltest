<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reporting.master" AutoEventWireup="true" CodeBehind="CalendarReport.aspx.cs" Inherits="LarpPortal.Reports.CalendarReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ReportsContent" runat="server">
    ...
    <div role="form" class="form-horizontal form-condensed">
        <div class="col-sm-12">
            <h3 class="col-sm-5">Events Calendar Report </h3>
        </div>
        <asp:Panel ID="pnlParameters" runat="server" Visible="true">
            <div class="col-sm-12">
                ...
                <div class="col-sm-1">
                    ...
                    <div class="row">
                        <asp:Button ID="btnExportExcel" runat="server" CssClass="StandardButton" Width="77px" Text="Export Excel" OnClick="btnExportExcel_Click" Visible="false" />
                    </div>
                    <div class="row">
                        <div style="padding-right: 20px;">
                            <asp:Button ID="btnExportCSV" runat="server" CssClass="StandardButton" Width="77px"  Text="Export csv" OnClick="btnExportCSV_Click" Visible="false" />
                        </div>
                    </div>
                </div>
            </div>
