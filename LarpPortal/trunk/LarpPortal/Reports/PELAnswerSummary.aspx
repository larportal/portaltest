<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Reporting.master" AutoEventWireup="true" CodeBehind="PELAnswerSummary.aspx.cs" Inherits="LarpPortal.Reports.PELAnswerSummary" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ReportsContent" runat="server">
    ...
    <div role="form" class="form-horizontal form-condensed">
        <div class="col-sm-12">
            <h3 class="col-sm-12">PEL Answer Summary Report</h3>
        </div>
