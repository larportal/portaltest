                        ...
                        <div class="panel-wrapper">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="panel-container" style="padding-right:0px">
                                        <div class="pre-scrollable scroll-200">
                                            ...
                                            <div class="form-group">
                                                <asp:Label AssociatedControlID="txtGenres" ID="lblGenres" runat="server" CssClass="col-sm-3 control-label">Genres</asp:Label>
                                                <div class="col-sm-9">
                                                    <asp:TextBox ID="txtGenres" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
