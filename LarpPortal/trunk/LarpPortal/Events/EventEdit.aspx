        ...
        <section id="character-info" class="character-info tab-pane active">
            <div role="form" class="form-horizontal panel">
                ...
                <div class="row col-lg-12 NoPadding">
                    <div class="TableLabel col-sm-2">Start Date/Time</div>
                    ...
                    <div class="TableLabel col-sm-2">End Date/Time</div>
                    <div class="col-sm-2 NoPadding">
                ...
                <div class="row col-lg-12 NoPadding">
                    <div class="TableLabel col-lg-2">Site</div>
                ...
                <div class="row col-lg-12 NoPadding">
                    <div class="TableLabel col-lg-2">Event Name</div>
                    <div class="col-lg-6 NoPadding">
                        <asp:TextBox ID="tbEventName" runat="server" CssClass="col-sm-8" />
                        <asp:RequiredFieldValidator ID="rfvEventName" runat="server" ControlToValidate="tbEventName"
                            CssClass="ErrorDisplay" Text="* Required" Display="Dynamic" />
                    </div>
                </div>
                <div class="row col-lg-12 NoPadding">
                    <div class="TableLabel col-lg-2">Event Description</div>
                    <div class="col-lg-6 NoPadding">
                        <asp:TextBox ID="tbEventDescription" runat="server" CssClass="col-sm-8" />
                        <asp:RequiredFieldValidator ID="rfvEventDescription" runat="server" ControlToValidate="tbEventDescription"
                            CssClass="ErrorDisplay" Text="* Required" Display="Dynamic" />
                    </div>
                </div>
                <div class="row col-lg-12 NoPadding">
                    <div class="TableLabel col-lg-2">In Game Location</div>
                    <div class="col-lg-6 NoPadding">
                        <asp:TextBox ID="tbGameLocation" runat="server" CssClass="col-lg-8" />
